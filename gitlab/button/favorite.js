(function() {
    ...
    async function openManagerModal() {
        // Shared white/silver glassmorphism styling (matches the GitHub modal).
        ...
        Object.assign(box.style, { width: '400px', maxHeight: '80%', background: 'rgba(255, 255, 255, 0.75)', border: '1px solid rgba(255, 255, 255, 0.6)', borderRadius: '20px', boxShadow: '0 16px 48px rgba(120, 130, 150, 0.3)', backdropFilter: 'blur(24px) saturate(180%)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', display: 'flex', flexDirection: 'column', overflow: 'hidden', fontFamily: '"GitLab Sans", sans-serif' });

        const header = document.createElement('div');
        header.innerHTML = '<h3 style="margin:0; color:#2b2f36;">Manage Locations</h3>';
        ...
        Object.assign(searchContainer.style, { padding: '10px 20px', borderBottom: '1px solid rgba(180, 190, 205, 0.4)', background: 'transparent' });
        const searchInput = document.createElement('input'); searchInput.placeholder = 'Search folders...';
        Object.assign(searchInput.style, { width: '100%', padding: '8px', borderRadius: '8px', border: '1px solid rgba(180, 190, 205, 0.5)', background: 'rgba(255, 255, 255, 0.6)', color: '#2b2f36' });
        searchContainer.appendChild(searchInput); box.appendChild(searchContainer);

        const filterBar = document.createElement('div');
        Object.assign(filterBar.style, { padding: '5px 20px 10px', background: 'transparent', borderBottom: '1px solid rgba(180, 190, 205, 0.4)', overflowX: 'auto', display: 'flex', gap: '5px' });
